...
public class ErrorScreenCapture {
    ...
    public static String getScreenshort(WebDriver driver, String screenshotName) {
        String timestamp = new SimpleDateFormat("yyyyMMdd_HHmmss").format(new Date());
        //String filePath = "src/test/resources/ScreenShots/" + screenshotName + "_" + timestamp + ".png";
        String filePath = "C:/Users/VRATNKA/Desktop/NewMITProject/ScreenShort" + screenshotName + "_" + timestamp + ".png";
        // Take the screenshot
